---
name: git-workflow
description: Git branching strategies, rebasing, conflict resolution, cherry-picking, and repository maintenance.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: Branching + commits + merges
- APPLY: Conventional commits, small PRs, clean history
- VERIFY: Hooks + CI pass; history readable
- ANTI-PATTERNS: Force-push, giant PRs
<!-- /QWEN-STYLE -->
