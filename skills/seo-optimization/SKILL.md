...
description: Technical SEO: meta tags, structured data, Core Web Vitals, sitemap, robots.txt, and performance.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: Technical + on-page SEO
- APPLY: Meta, structured data, CWV, sitemap
- VERIFY: CWV + index check
- ANTI-PATTERNS: Keyword stuffing, broken canonicals
<!-- /QWEN-STYLE -->
