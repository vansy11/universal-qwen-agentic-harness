...
description: Profile and optimize application performance: bundle size, memory, CPU, database queries, and caching.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: Profile-driven optimization
- APPLY: Measure first; fix hot paths; cache wisely
- VERIFY: Before/after benchmarks
- ANTI-PATTERNS: Optimizing without profiling
<!-- /QWEN-STYLE -->
