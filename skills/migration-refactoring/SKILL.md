...
description: Legacy code migration patterns: framework upgrades, language ports, monolith-to-microservices.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: Legacy → modern migration
- APPLY: Strangler pattern, behavior locks, incremental
- VERIFY: Behavior identical pre/post; tests green
- ANTI-PATTERNS: Big-bang rewrite
<!-- /QWEN-STYLE -->
