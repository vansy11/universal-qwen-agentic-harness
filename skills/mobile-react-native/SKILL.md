...
description: Build React Native apps with Expo, navigation, native modules, and offline-first architecture.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: RN/Flutter mobile craft
- APPLY: Offline-first, native nav, perf budgets
- VERIFY: Emulator build + profile
- ANTI-PATTERNS: Heavy JS thread, untested gestures
<!-- /QWEN-STYLE -->
