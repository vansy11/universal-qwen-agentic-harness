...
description: Set up logging, metrics, tracing, alerting, and dashboards with Prometheus/Grafana/Datadog.
allowedTools:
  - task
  - read_file
  - write_file
...
- APPLY: RED/USE metrics, SLO-based alerts
- VERIFY: Dashboards + alert fire test
- ANTI-PATTERNS: Noisy alerts, missing SLOs
<!-- /QWEN-STYLE -->
