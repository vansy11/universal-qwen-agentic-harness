---
name: api-testing
description: Write API tests with contract testing, load testing, and integration test suites.
allowedTools:
  - task
  - read_file
  - write_file
...
Focus: Contract + load + integration tests
- APPLY: Schema contracts, edge cases, load profiles
- VERIFY: Contract + load run green
- ANTI-PATTERNS: Only happy-path tests
<!-- /QWEN-STYLE -->
